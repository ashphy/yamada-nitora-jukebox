...
*/
    ...
    function Da(a, b) {
        ua(a.i); var c = a.i.o; if (c) return Ea(a, "return" in c ? c["return"] : function (d) { return { value: d, done: !0 } }, b, a.i.return);
    ...
    function Ga(a) {
        this.next = function (b) { ua(a.i); a.i.o ? b = Ea(a, a.i.o.next, b, a.i.C) : (a.i.C(b), b = Fa(a)); return b };
    ...
    r("Promise", function (a) {
        function b(g) { this.i = 0; this.l = void 0; this.j = []; this.u = !1; var h = this.o(); try { g(h.resolve, h.reject) } catch (k) { h.reject(k) } }
        ...
        b.prototype.then = function (g, h) {
            function k(t, p) { return "function" == typeof t ? function (y) { try { l(t(y)) } catch (z) { m(z) } } : p }
            var l, m, q = new b(function (t, p) { l = t; m = p });
            this.sa(k(g, l), k(h, m)); return q
        };
        b.prototype.catch = function (g) { return this.then(void 0, g) };
        b.prototype.sa = function (g, h) {
            function k() { switch (l.i) { case 1: g(l.l); break; case 2: h(l.l); break; default: throw Error("Unexpected state: " + l.i); } }
        ...
        b.all = function (g) {
            var h = u(g), k = h.next(); return k.done ? d([]) : new b(function (l, m) {
                function q(y) { return function (z) { t[y] = z; p--; 0 == p && l(t) } }
    ...
    r("WeakMap", function (a) {
        function b(k) { this.i = (h += Math.random() + 1).toString(); if (k) { k = u(k); for (var l; !(l = k.next()).done;)l = l.value, this.set(l[0], l[1]) } }
        function c() { }
    ...
    r("Set", function (a) {
        function b(c) { this.i = new Map; if (c) { c = u(c); for (var d; !(d = c.next()).done;)this.add(d.value) } this.size = this.i.size }
    ...
    ; var cb = Array.prototype.indexOf ? function (a, b) { return Array.prototype.indexOf.call(a, b, void 0) } : function (a, b) {
        if ("string" === typeof a) return "string" !== typeof b || 1 != b.length ? -1 : a.indexOf(b, 0);
        for (var c = 0; c < a.length; c++)if (c in a && a[c] === b) return c; return -1
    }, D = Array.prototype.forEach ? function (a, b, c) { Array.prototype.forEach.call(a, b, c) } : function (a, b, c) { for (var d = a.length, e = "string" === typeof a ? a.split("") : a, f = 0; f < d; f++)f in e && b.call(c, e[f], f, a) }, db = Array.prototype.reduce ? function (a, b, c) { return Array.prototype.reduce.call(a, b, c) } : function (a, b, c) {
        var d = c;
    ...
    var jc; a: {
        var kc = "", lc = function () { var a = Kb(); if (gc) return /rv:([^\);]+)(\)|;)/.exec(a); if (fc) return /Edge\/([\d\.]+)/.exec(a); if (ec) return /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a); if (hc) return /WebKit\/(\S+)/.exec(a); if (dc) return /(?:Version)[ \/]?(\S+)/.exec(a) }();
        lc && (kc = lc ? lc[1] : ""); if (ec) { var mc = ic(); if (null != mc && mc > parseFloat(kc)) { jc = String(mc); break a } } jc = kc
    } var nc = jc, oc; if (A.document && ec) { var pc = ic(); oc = pc ? pc : parseInt(nc, 10) || void 0 } else oc = void 0; var qc = oc; var rc = bc() || E("iPod"), sc = E("iPad"); !E("Android") || Lb(); Lb(); var tc = E("Safari") && !(Lb() || E("Coast") || E("Opera") || E("Edge") || E("Edg/") || E("OPR") || E("Firefox") || E("FxiOS") || E("Silk") || E("Android")) && !(bc() || E("iPad") || E("iPod")); var vc = {}, wc = null;
    function xc(a, b) {
        Oa(a); void 0 === b && (b = 0); if (!wc) { wc = {}; for (var c = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".split(""), d = ["+/=", "+/", "-_=", "-_.", "-_"], e = 0; 5 > e; e++) { var f = c.concat(d[e].split("")); vc[e] = f; for (var g = 0; g < f.length; g++) { var h = f[g]; void 0 === wc[h] && (wc[h] = g) } } } b = vc[b]; c = Array(Math.floor(a.length / 3)); d = b[64] || ""; for (e = f = 0; f < a.length - 2; f += 3) { var k = a[f], l = a[f + 1]; h = a[f + 2]; g = b[k >> 2]; k = b[(k & 3) << 4 | l >> 4]; l = b[(l & 15) << 2 | h >> 6]; h = b[h & 63]; c[e++] = "" + g + k + l + h } g = 0; h = d; switch (a.length -
...
*/
    ...
    function Nd() {
        var a = Od(), b = {}; D(Kd(), function (c) { a.sandbox && a.sandbox.supports && a.sandbox.supports(c) && (b[c] = !0) });
        return b
    }
    function Od() { var a = void 0 === a ? document : a; return a.createElement("iframe") }
    ; var Pd = (new Date).getTime(); var Qd = new function (a, b) { this.flag = a; this.defaultValue = void 0 === b ? !1 : b }(434462125, !0); function Rd(a) {
    ...
    ; var Sd = "client_dev_mss_url client_dev_regex_map client_dev_root_url client_rollout_override expflag forcedCapability jsfeat jsmode mods".split(" "); ia(Sd); function Td() {
    ...
    function Vd(a, b, c) {
        var d = [], e = []; if (1 == (Array.isArray(c) ? 2 : 1)) return e = [b, a], D(d, function (h) { e.push(h) }), Wd(e.join(" "));
    ...
    function be(a) {
        var b = void 0 === b ? !1 : b; var c = Rd(String(A.location.href)), d = []; var e = b; e = void 0 === e ? !1 : e; var f = A.__SAPISID || A.__APISID || A.__3PSAPISID || A.__OVERRIDE_SID; $d(e) && (f = f || A.__1PSAPISID); if (f) e = !0; else { var g = new Yd(document); f = g.get("SAPISID") || g.get("APISID") || g.get("__Secure-3PAPISID") || g.get("SID"); $d(e) && (f = f || g.get("__Secure-1PAPISID")); e = !!f } e && (e = (c = 0 == c.indexOf("https:") || 0 == c.indexOf("chrome-extension:") || 0 == c.indexOf("moz-extension:")) ? A.__SAPISID : A.__APISID, e || (e = new Yd(document),
    ...
    de.prototype.preventDefault = function () { this.defaultPrevented = !0 }; function ee(a) {
        var b = B("window.location.href"); null == a && (a = 'Unknown Error of type "null/undefined"'); if ("string" === typeof a) return { message: a, name: "Unknown error", lineNumber: "Not available", fileName: b, stack: "Not available" }; var c = !1; try { var d = a.lineNumber || a.line || "Not available" } catch (g) { d = "Not available", c = !0 } try { var e = a.fileName || a.filename || a.sourceURL || A.$googDebugFname || b } catch (g) { e = "Not available", c = !0 } b = fe(a); if (!(!c && a.lineNumber && a.fileName && a.stack && a.message && a.name)) {
            c = a.message; if (null ==
    ...
    }(); function je(a, b) { de.call(this, a ? a.type : ""); this.relatedTarget = this.i = this.target = null; this.button = this.screenY = this.screenX = this.clientY = this.clientX = 0; this.key = ""; this.charCode = this.keyCode = 0; this.metaKey = this.shiftKey = this.altKey = this.ctrlKey = !1; this.state = null; this.pointerId = 0; this.pointerType = ""; this.j = null; a && this.init(a, b) }
    Wa(je, de); var ke = { 2: "touch", 3: "pen", 4: "mouse" };
    je.prototype.init = function (a, b) {
        var c = this.type = a.type, d = a.changedTouches && a.changedTouches.length ? a.changedTouches[0] : null; this.target = a.target || a.srcElement; this.i = b; if (b = a.relatedTarget) { if (gc) { a: { try { cc(b.nodeName); var e = !0; break a } catch (f) { } e = !1 } e || (b = null) } } else "mouseover" == c ? b = a.fromElement : "mouseout" == c && (b = a.toElement); this.relatedTarget = b; d ? (this.clientX = void 0 !== d.clientX ? d.clientX : d.pageX, this.clientY = void 0 !== d.clientY ? d.clientY : d.pageY, this.screenX = d.screenX || 0, this.screenY = d.screenY ||
    ...
    var Fe = "__closure_events_fn_" + (1E9 * Math.random() >>> 0); function xe(a) {
        if ("function" === typeof a) return a; a[Fe] || (a[Fe] = function (b) { return a.handleEvent(b) });
        return a[Fe]
    }
    ...
    ; function Ie(a) {
        J.call(this); var b = this; this.C = this.j = 0; this.K = null != a ? a : {
            M: function (e, f) { return setTimeout(e, f) },
    ...
    function Je(a, b) {
        return a.u ? a.u : a.u = new Promise(function (c) {
            var d, e, f, g; return x(function (h) {
                switch (h.i) {
                    case 1: return d = window.AbortController ? new window.AbortController : void 0, f = null == (e = d) ? void 0 : e.signal, g = !1, xa(h, 2, 3), d && (a.j = a.K.M(function () { d.abort() }, b || 2E4)), w(h, fetch("/generate_204", {
                        method: "HEAD",
                        signal: f
                    }), 5); case 5: g = !0; case 3: Aa(h); a.u = void 0; a.j && (a.K.aa(a.j), a.j = 0); g !== a.i && (a.i = g, a.i ? Ge(a, "networkstatus-online") : Ge(a, "networkstatus-offline")); c(g); Ba(h); break; case 2: za(h), g = !1, h.s(3)
                }
            })
        })
    }
    ...
    function Oe(a) {
        -1 === a.i && (a.i = db(a.data_, function (b, c, d) { return c ? b + Math.pow(2, d) : b }, 0));
        return a.i
    }
    ...
    function df(a) {
        var b, c; if ("function" !== typeof (null == (b = a.navigator) ? void 0 : null == (c = b.userAgentData) ? void 0 : c.getHighEntropyValues)) return null; var d = cf(a); if (d.uach_promise) return d.uach_promise; a = a.navigator.userAgentData.getHighEntropyValues(bf).then(function (e) { null != d.uach || (d.uach = e); return e });
    ...
    function ff() {
        var a = window; if (Pe().B(Qd.flag, Qd.defaultValue)) { var b, c; return null != (c = null == (b = df(a)) ? void 0 : b.then(function (g) { return ef(g) })) ? c : null } var d, e;
    ...
    ; var jf; function kf() {
        var a = A.MessageChannel; "undefined" === typeof a && "undefined" !== typeof window && window.postMessage && window.addEventListener && !E("Presto") && (a = function () {
            var e = Fd(); e.style.display = "none"; document.documentElement.appendChild(e); var f = e.contentWindow; e = f.document; e.open(); e.close(); var g = "callImmediate" + Math.random(), h = "file:" == f.location.protocol ? "*" : f.location.protocol + "//" + f.location.host; e = Va(function (k) { if (("*" == h || k.origin == h) && k.data == g) this.port1.onmessage() }, this);
            f.addEventListener("message", e, !1); this.port1 = {}; this.port2 = { postMessage: function () { f.postMessage(g, h) } }
        });
        if ("undefined" !== typeof a && !E("Trident") && !E("MSIE")) {
            var b = new a, c = {}, d = c; b.port1.onmessage = function () { if (void 0 !== c.next) { c = c.next; var e = c.Qa; c.Qa = null; e() } };
            return function (e) { d.next = { Qa: e }; d = d.next; b.port2.postMessage(0) }
    ...
    function sf() {
        if (A.Promise && A.Promise.resolve) { var a = A.Promise.resolve(void 0); of = function () { a.then(tf) } } else of = function () {
            var b = tf;
    ...
    function yf(a, b, c) {
        ...
        } a.i[0] = a.i[0] + b & 4294967295; a.i[1] = a.i[1] + c & 4294967295; a.i[2] = a.i[2] + g & 4294967295; a.i[3] = a.i[3] + h & 4294967295; a.i[4] = a.i[4] + k & 4294967295
    }
    ...
    zf.prototype.L = function () { return this }; function Cf(a) {
        if (a instanceof Df || a instanceof Ef || a instanceof Ff) return a; if ("function" == typeof a.next) return new Df(function () { return a });
    ...
    function Ff(a) {
        Df.call(this, function () { return a });
        this.l = a
    }
    ...
    n.L = function (a) {
        If(this); var b = 0, c = this.l, d = this, e = new zf; e.next = function () { if (c != d.l) throw Error("The map has changed since the iterator was created"); if (b >= d.i.length) return Af; var f = d.i[b++]; return Bf(a ? f : d.j[f]) };
        return e
    };
    ...
    function og(a, b, c, d) {
        var e = ng(null, null, null); e.i = new Nf(function (f, g) {
    ...
    n.L = function (a) {
        var b = 0, c = this.i, d = new zf; d.next = function () { if (b >= c.length) return Af; var e = c.key(b++); if (a) return Bf(e); e = c.getItem(e); if ("string" !== typeof e) throw "Storage mechanism: Invalid value was encountered"; return Bf(e) };
        return d
    };
    ...
    n.L = function (a) {
        var b = 0, c = this.i.XMLDocument.documentElement.attributes, d = new zf; d.next = function () { if (b >= c.length) return Af; var e = c[b++]; if (a) return Bf(decodeURIComponent(e.nodeName.replace(/\./g, "%")).slice(1)); e = e.nodeValue; if ("string" !== typeof e) throw "Storage mechanism: Invalid value was encountered"; return Bf(e) };
        return d
    };
    ...
    Qg.prototype.L = function (a) {
        var b = this.j[Symbol.iterator](), c = this, d = new zf; d.next = function () { var e = b.next(); if (e.done) return e; for (e = e.value; e.slice(0, c.i.length) != c.i;) { e = b.next(); if (e.done) return e; e = e.value } return Bf(a ? e.slice(c.i.length) : c.j.get(e)) };
        return d
    }; function Rg(a) { I.call(this, a) }
    ...
    function Oh(a) {
        this.type = ""; this.state = this.source = this.data = this.currentTarget = this.relatedTarget = this.target = null; this.charCode = this.keyCode = 0; this.metaKey = this.shiftKey = this.ctrlKey = this.altKey = !1; this.rotation = this.clientY = this.clientX = 0; this.changedTouches = this.touches = null; try {
            if (a = a || window.event) {
                this.event = a; for (var b in a) b in Nh || (this[b] = a[b]); this.rotation = a.rotation; var c = a.target || a.srcElement; c && 3 == c.nodeType && (c = c.parentNode); this.target = c; var d = a.relatedTarget; if (d) try {
                    d = d.nodeName ?
                        d : null
    ...
    function Th(a, b, c) {
        var d = void 0 === d ? {} : d; if (a && (a.addEventListener || a.attachEvent)) {
            var e = Qh(a, b, c, d); if (!e) {
                e = ++Ph.count + ""; var f = !("mouseenter" != b && "mouseleave" != b || !a.addEventListener || "onmouseenter" in document); var g = f ? function (h) { h = new Oh(h); if (!Gd(h.relatedTarget, function (k) { return k == a })) return h.currentTarget = a, h.type = b, c.call(a, h) } : function (h) {
                    h = new Oh(h);
    ...
    var $h = String(Yh); function ai(a) {
        var b = []; ib(a, function (c, d) { var e = encodeURIComponent(String(d)), f; Array.isArray(c) ? f = c : f = [c]; D(f, function (g) { "" == g ? b.push(e) : b.push(e + "=" + encodeURIComponent(String(g))) }) });
        return b.join("&")
    }
    ...
    ; function hi(a) {
        var b = ii; a = void 0 === a ? B("yt.ads.biscotti.lastId_") || "" : a; var c = Object, d = c.assign, e = {}; e.dt = Pd; e.flash = "0"; a: { try { var f = b.i.top.location.href } catch (X) { f = 2; break a } f = f ? f === b.j.location.href ? 0 : 1 : 2 } e = (e.frm = f, e); try {
            e.u_tz = -(new Date).getTimezoneOffset(); var g = void 0 === g ? xd : g; try { var h = g.history.length } catch (X) { h = 0 } e.u_his = h; var k; e.u_h = null == (k = xd.screen) ? void 0 : k.height; var l; e.u_w = null == (l = xd.screen) ? void 0 : l.width; var m; e.u_ah = null == (m = xd.screen) ? void 0 : m.availHeight; var q; e.u_aw = null ==
                (q = xd.screen) ? void 0 : q.availWidth; var t; e.u_cd = null == (t = xd.screen) ? void 0 : t.colorDepth
        } catch (X) { } h = b.i; try { var p = h.screenX; var y = h.screenY } catch (X) { } try { var z = h.outerWidth; var G = h.outerHeight } catch (X) { } try { var K = h.innerWidth; var M = h.innerHeight } catch (X) { } try { var P = h.screenLeft; var kb = h.screenTop } catch (X) { } try { K = h.innerWidth, M = h.innerHeight } catch (X) { } try { var uc = h.screen.availWidth; var va = h.screen.availTop } catch (X) { } p = [P, kb, p, y, uc, va, z, G, K, M]; y = b.i.top; try {
            var na = (y || window).document, Y = "CSS1Compat" ==
                na.compatMode ? na.documentElement : na.body; var ba = (new Ed(Y.clientWidth, Y.clientHeight)).round()
        } catch (X) { ba = new Ed(-12245933, -12245933) } na = ba; ba = {}; var ca = void 0 === ca ? A : ca; Y = new Ne; ca.SVGElement && ca.document.createElementNS && Y.set(0); y = Nd(); y["allow-top-navigation-by-user-activation"] && Y.set(1); y["allow-popups-to-escape-sandbox"] && Y.set(2); ca.crypto && ca.crypto.subtle && Y.set(3); ca.TextDecoder && ca.TextEncoder && Y.set(4); ca = Oe(Y); ba.bc = ca; ba.bih = na.height; ba.biw = na.width; ba.brdim = p.join(); b = b.j; b = (ba.vis =
    ...
    }, mi = "app debugcss debugjs expflag force_ad_params force_ad_encrypted force_viral_ad_response_params forced_experiments innertube_snapshots innertube_goldens internalcountrycode internalipoverride absolute_experiments conditional_experiments sbb sr_bns_address".split(" ").concat(ia(Sd)), ni = !1;
    function oi(a, b) {
        b = void 0 === b ? {} : b; var c = di(a), d = O("web_ajax_ignore_global_headers_if_set"), e; for (e in li) { var f = N(li[e]); O("enable_visitor_header_for_vss") && "X-Goog-Visitor-Id" === e && !f && (f = N("VISITOR_DATA")); !f || !c && Qb(a) || d && void 0 !== b[e] || !O("enable_web_eom_visitor_data") && "X-Goog-EOM-Visitor-Id" === e || (b[e] = f) } "X-Goog-EOM-Visitor-Id" in b && "X-Goog-Visitor-Id" in b && delete b["X-Goog-Visitor-Id"]; if (c || !Qb(a)) b["X-YouTube-Utc-Offset"] = String(-(new Date).getTimezoneOffset()); if (c || !Qb(a)) {
            try {
                var g =
                    (new Intl.DateTimeFormat).resolvedOptions().timeZone
            } catch (h) { } g && (b["X-YouTube-Time-Zone"] = g)
        } if (c || !Qb(a)) b["X-YouTube-Ad-Signals"] = ai(hi()); return b
    }
    function pi(a) {
        var b = window.location.search, c = Qb(a); O("debug_handle_relative_url_for_query_forward_killswitch") || c || !di(a) || (c = document.location.hostname); var d = Pb(a.match(Ob)[5] || null); d = (c = c && (c.endsWith("youtube.com") || c.endsWith("youtube-nocookie.com"))) && d && d.startsWith("/api/"); if (!c || d) return a; var e = bi(b), f = {}; D(mi, function (g) { e[g] && (f[g] = e[g]) });
        return ci(a, f || {}, !1)
    }
    function qi(a, b) {
        var c = b.format || "JSON"; a = ri(a, b); var d = si(a, b), e = !1, f = ti(a, function (k) {
            if (!e) {
                e = !0; h && window.clearTimeout(h); a: switch (k && "status" in k ? k.status : -1) { case 200: case 201: case 202: case 203: case 204: case 205: case 206: case 304: var l = !0; break a; default: l = !1 }var m = null, q = 400 <= k.status && 500 > k.status, t = 500 <= k.status && 600 > k.status; if (l || q || t) m = ui(a, c, k, b.convertToSafeHtml); if (l) a: if (k && 204 == k.status) l = !0; else {
                    switch (c) { case "XML": l = 0 == parseInt(m && m.return_code, 10); break a; case "RAW": l = !0; break a }l =
                        !!m
                } m = m || {}; q = b.context || A; l ? b.onSuccess && b.onSuccess.call(q, k, m) : b.onError && b.onError.call(q, k, m); b.onFinish && b.onFinish.call(q, k, m)
            }
    ...
    function si(a, b) {
        ...
        } !ni && a && "POST" != b.method && (ni = !0, Kh(Error("AJAX request with postData should use POST"))); return e
    }
    function ui(a, b, c, d) {
        var e = null; switch (b) { case "JSON": try { var f = c.responseText } catch (g) { throw d = Error("Error reading responseText"), d.params = a, Lh(d), g; } a = c.getResponseHeader("Content-Type") || ""; f && 0 <= a.indexOf("json") && (")]}'\n" === f.substring(0, 5) && (f = f.substring(5)), e = JSON.parse(f)); break; case "XML": if (a = (a = c.responseXML) ? vi(a) : null) e = {}, D(a.getElementsByTagName("*"), function (g) { e[g.tagName] = wi(g) }) }d && xi(e);
        return e
    }
    ...
    function wi(a) {
        var b = ""; D(a.childNodes, function (c) { b += c.nodeValue });
        return b
    }
    function ti(a, b, c, d, e, f, g) {
        function h() { 4 == (k && "readyState" in k ? k.readyState : 0) && b && Jh(b)(k) }
    ...
    function Pj(a, b) {
        var c = new Promise(function (d, e) { try { Cj(b(a).then(function (f) { d(f) }), e) } catch (f) { e(f), a.abort() } });
    ...
    n.update = function (a) { return V(this.cursor.update(a)) }; function Mk(a, b, c) {
        return new Promise(function (d, e) {
            function f() { t || (t = new Jj(g.result, { closed: q })); return t }
            var g = void 0 !== b ? self.indexedDB.open(a, b) : self.indexedDB.open(a); var h = c.blocked, k = c.blocking, l = c.Ab, m = c.upgrade, q = c.closed, t; g.addEventListener("upgradeneeded", function (p) {
                try {
    ...
    function Ok(a, b) {
        b = void 0 === b ? {} : b; var c, d, e, f; return x(function (g) {
            if (1 == g.i) return xa(g, 2), c = self.indexedDB.deleteDatabase(a), d = b, (e = d.blocked) && c.addEventListener("blocked", function () { e() }), w(g, Hj(c), 4);
    ...
    function Tk(a) {
        function b() {
            var f, g, h, k, l, m, q, t, p, y; return x(function (z) {
                switch (z.i) {
        ...
        if (!a.o) throw Rk(a); if (a.i) return a.i; var d = {
            blocking: function (f) { f.close() },
            closed: c, Ab: c, upgrade: a.options.upgrade
        }; var e = b(); a.i = e; return a.i
    }
    ...
    function jl(a, b, c) {
        a = a.map(function (d) { return x(function (e) { return 1 == e.i ? w(e, Ok(d.actualName, b), 2) : w(e, Wk(d.actualName, c), 0) }) });
    ...
    ; function ml(a) {
        this.qa = this.i = !1; this.potentialEsfErrorCounter = this.j = 0; this.handleError = function () { };
        this.ea = function () { };
    ...
    n = ml.prototype; n.writeThenSend = function (a, b) {
        var c = this; b = void 0 === b ? {} : b; if (nl(this) && this.i) {
            var d = { url: a, options: b, timestamp: this.now(), status: "NEW", sendCount: 0 }; this.F.set(d, this.A).then(function (e) { d.id = e; c.H.G() && ql(c, d) }).catch(function (e) {
                ql(c, d);
                rl(c, e)
            })
        } else this.U(a, b)
    ...
    n.sendThenWrite = function (a, b, c) {
        var d = this; b = void 0 === b ? {} : b; if (nl(this) && this.i) {
            var e = { url: a, options: b, timestamp: this.now(), status: "NEW", sendCount: 0 }; this.B && this.B("nwl_skip_retry") && (e.skipRetry = c); if (this.H.G() || this.B && this.B("nwl_aggressive_send_then_write") && !e.skipRetry) {
                if (!e.skipRetry) {
                    var f = b.onError ? b.onError : function () { };
                    b.onError = function (g, h) {
                        return x(function (k) {
                            if (1 == k.i) return w(k, d.F.set(e, d.A).catch(function (l) { rl(d, l) }), 2);
                            f(g, h); k.i = 0
                        })
                    }
    ...
    n.sendAndWrite = function (a, b) {
        var c = this; b = void 0 === b ? {} : b; if (nl(this) && this.i) {
            ...
            this.U(d.url, d.options); this.F.set(d, this.A).then(function (g) { d.id = g; e && c.F.da(d.id, c.A) }).catch(function (g) { rl(c, g) })
        } else this.U(a, b)
    };
    ...
    ; var zl;
    function Al() {
        if (zl) return zl(); var a = {}; zl = yl("LogsDatabaseV2", {
    ...
    ; var Kl = {}, Ll = yl("ServiceWorkerLogsDatabase", {
        ka: (Kl.SWHealthLog = { Ba: 1 }, Kl), La: !0, upgrade: function (a, b) { b(1) && Lj(a, "SWHealthLog", { keyPath: "id", autoIncrement: !0 }).i.createIndex("swHealthNewRequest", ["interface", "timestamp"], { unique: !1 }) },
        version: 1
    }); function Ml(a) { return Sk(Ll(), a) }
    ...
    function Sl(a) {
        var b = new Image, c = "" + Ql++; Pl[c] = b; b.onload = b.onerror = function () { delete Pl[c] };
        b.src = a
    }
    ...
    n.V = function (a) {
        var b = this; if (O("use_shared_nsm") && this.i) {
            var c = Je(this.i, a); c.then(function (d) { O("use_cfr_monitor") && Tl().requestComplete("generate_204", d) });
            return c
        } return this.u ? this.u : this.u = new Promise(function (d) {
            var e, f, g, h; return x(function (k) {
                switch (k.i) {
                    case 1: return e = window.AbortController ? new window.AbortController : void 0, g = null == (f = e) ? void 0 : f.signal, h = !1, xa(k, 2, 3), e && (b.P = Me.M(function () { e.abort() }, a || 2E4)), w(k, fetch("/generate_204", {
                        method: "HEAD",
                        signal: g
                    }), 5); case 5: h = !0; case 3: Aa(k); O("use_cfr_monitor") && Tl().requestComplete("generate_204", h); b.u = void 0; b.P && Me.aa(b.P); h !== b.j && (b.j = h, b.j && b.m ? Ge(b, "ytnetworkstatus-online") : b.m && Ge(b, "ytnetworkstatus-offline")); d(h); Ba(k); break; case 2: za(k), h = !1, k.s(3)
                }
            })
        })
    };
    Z.prototype.sendNetworkCheckRequest = Z.prototype.V; Z.prototype.listen = Z.prototype.S; Z.prototype.enableErrorFlushing = Z.prototype.qb; Z.prototype.getWindowStatus = Z.prototype.Da; Z.prototype.monitorNetworkStatusChange = Z.prototype.xb; Z.prototype.networkStatusHint = Z.prototype.T; Z.prototype.isNetworkAvailable = Z.prototype.G; Z.getInstance = am; function cm(a) {
        a = void 0 === a ? {} : a; J.call(this); var b = this; this.j = this.P = 0; this.m = "ytnetworkstatus-offline"; this.u = "ytnetworkstatus-online"; O("use_shared_nsm") && (this.m = "networkstatus-offline", this.u = "networkstatus-online"); this.i = am(); var c = B("yt.networkStatusManager.instance.monitorNetworkStatusChange").bind(this.i); c && c(a.Sa); a.Za && (c = B("yt.networkStatusManager.instance.enableErrorFlushing").bind(this.i)) && c(); if (c = B("yt.networkStatusManager.instance.listen").bind(this.i)) a.za ? (this.za = a.za, c(this.u,
    ...
    v(fm, ml); function im() {
        var a = B("yt.networklessRequestController.instance"); a || (a = new fm, C("yt.networklessRequestController.instance", a), O("networkless_logging") && dl().then(function (b) { a.A = b; ol(a); a.l.resolve(); a.va && Math.random() <= a.ta && a.A && Nl(a.A); O("networkless_immediately_drop_sw_health_store") && jm(a) }));
        return a
    }
    ...
    ; var lm = 0, mm = 0, nm, om = A.ytNetworklessLoggingInitializationOptions || { isNwlInitialized: !1, potentialEsfErrorCounter: mm }; C("ytNetworklessLoggingInitializationOptions", om); function pm(a, b) {
        function c(d) {
            var e = qm().G(); if (!rm() || !d || e && O("vss_networkless_bypass_write")) sm(a, b); else {
                var f = { url: a, options: b, timestamp: Q(), status: "NEW", sendCount: 0 }; Cl(f, d).then(function (g) { f.id = g; qm().G() && tm(f) }).catch(function (g) {
                    tm(f);
                    qm().G() ? Kh(g) : Wl(g)
                })
            }
    ...
    function um(a, b) {
        function c(d) {
            if (rm() && d) {
                var e = { url: a, options: b, timestamp: Q(), status: "NEW", sendCount: 0 }, f = !1, g = b.onSuccess ? b.onSuccess : function () { };
                ...
                if (O("use_cfr_monitor")) {
                    ...
                    e.options.onError = function (k, l) { Tl().requestComplete(e.url, !1); h(k, l) }
                } sm(e.url, e.options);
                Cl(e, d).then(function (k) { e.id = k; f && Hl(e.id, d) }).catch(function (k) { qm().G() ? Kh(k) : Wl(k) })
            } else sm(a, b)
        }
        b = void 0 === b ? {} : b; O("skip_is_supported_killswitch") ? dl().then(function (d) { c(d) }) : c(cl())
    }
    ...
    function Wi(a, b, c, d) {
        function e(y) {
            y = void 0 === y ? !1 : y; var z; if (d.retry && "www.youtube-nocookie.com" != h && (y || O("skip_ls_gel_retry") || "application/json" !== g.headers["Content-Type"] || (z = Ti(b, c, l, k)), z)) {
                var G = g.onSuccess, K = g.onFetchSuccess; g.onSuccess = function (M, P) { Ui(z); G(M, P) };
                c.onFetchSuccess = function (M, P) { Ui(z); K(M, P) }
            } try { y && d.retry && !d.ab.bypassNetworkless ? (g.method = "POST", d.ab.writeThenSend ? O("use_new_nwl_wts") ? im().writeThenSend(p, g) : pm(p, g) : O("use_new_nwl_saw") ? im().sendAndWrite(p, g) : um(p, g)) : (g.method = "POST", g.postParams || (g.postParams = {}), qi(p, g)) } catch (M) {
                if ("InvalidAccessError" == M.name) z && (Ui(z), z = 0), Lh(Error("An extension is blocking network request."));
                else throw M;
            } z && Yi(function () { Vi(a) }, 5E3)
        }
        !N("VISITOR_DATA") && "visitor_id" !== b && .01 > Math.random() && Lh(new jj("Missing VISITOR_DATA when sending innertube request.", b, c, d)); if (!a.isReady()) { var f = new jj("innertube xhrclient not ready", b, c, d); Kh(f); throw f; } var g = {
    ...
    ; var zm = { appSettingsCaptured: !0, visualElementAttached: !0, visualElementGestured: !0, visualElementHidden: !0, visualElementShown: !0, flowEvent: !0, visualElementStateChanged: !0, playbackAssociated: !0, youThere: !0, accountStateChangeSignedIn: !0, accountStateChangeSignedOut: !0 }, Am = {
        latencyActionBaselined: !0, latencyActionInfo: !0, latencyActionTicked: !0, bedrockRepetitiveActionTimed: !0, adsClientStateChange: !0, streamzIncremented: !0, mdxDialAdditionalDataUpdateEvent: !0, tvhtml5WatchKeyEvent: !0, tvhtml5VideoSeek: !0, tokenRefreshEvent: !0,
    ...
    }; function Bm() { var a = B("_lact", window); return null == a ? -1 : Math.max(Date.now() - a, 0) }
    ...
    function Vm(a, b, c) {
        a = void 0 === a ? {} : a; c = void 0 === c ? !1 : c; new Nf(function (d, e) {
            c ? (window.clearTimeout(Nm.j), window.clearTimeout(Nm.i), Nm.i = 0) : (window.clearTimeout(Mm.j), window.clearTimeout(Mm.i), Mm.i = 0); if (O("jspb_with_transport_leader") && !Jm) document.dispatchEvent(new CustomEvent("FLUSH_REQUEST")), d(); else if (Km && Km.isReady()) if (void 0 !== b) if (c) {
                e = new Map; var f = new Map, g = Rm.get(b) || []; e.set(b, g); O("jspb_with_transport_leader") && (g = Qm.get(b) || [], f.set(b, g)); dn(e, f, d, a); O("jspb_with_transport_leader") &&
                    Qm.delete(b); Rm.delete(b)
            } else f = new Map, g = Pm.get(b) || [], f.set(b, g), bn(f, d, e, a), Pm.delete(b); else c ? (dn(Rm, Qm, d, a), Rm.clear()) : (bn(Pm, d, e, a), Pm.clear()); else $m(c), d()
        })
    }
    function $m(a) {
        a = void 0 === a ? !1 : a; if (O("web_gel_timeout_cap") && (!a && !Mm.i || a && !Nm.i)) {
            var b = Uh(function () { Vm({ writeThenSend: !0 }, void 0, a) }, 6E4);
            a ? Nm.i = b : Mm.i = b
        } window.clearTimeout(a ? Nm.j : Mm.j); b = N("LOGGING_BATCH_TIMEOUT", fi("web_gel_debounce_ms", 1E4)); O("shorten_initial_gel_batch_timeout") && Om && (b = Hm); b = Uh(function () { Vm({ writeThenSend: !0 }, void 0, a) }, b);
        a ? Nm.j = b : Mm.j = b
    }
    function bn(a, b, c, d, e) {
        var f = Km; d = void 0 === d ? {} : d; var g = Math.round(Q()), h = a.size; a = u(a); for (var k = a.next(); !k.done; k = a.next()) {
            var l = u(k.value); k = l.next().value; var m = l.next().value; l = k; k = nb({ context: Hi(f.config_ || Gi()) }); k.events = m; (m = Sm[l]) && en(k, l, m); delete Sm[l]; l = "visitorOnlyApprovedKey" === l; fn(k, g, l); gn(d); m = function () { h--; h || b() };
            var q = function () { h--; h || b() };
            try { Wi(f, "log_event", k, hn(d, l, m, q, e)), Om = !1 } catch (t) { Kh(t), c() }
        }
    }
    function dn(a, b, c, d, e) {
        var f = Km; d = void 0 === d ? {} : d; var g = Math.round(Q()), h = a.size + b.size, k = new Map([].concat(ia(a), ia(b))); k = u(k); for (var l = k.next(); !l.done; l = k.next()) {
            var m = u(l.value).next().value, q = a.get(m), t = b.get(m) || []; l = new yh; var p = Mi(f.config_ || Gi()); H(l, dh, 1, p); q = q ? jn(q) : []; q = u(q); for (p = q.next(); !p.done; p = q.next())md(l, 3, th, p.value); t = u(t); for (q = t.next(); !q.done; q = t.next())md(l, 3, th, q.value); (t = Tm[m]) && kn(l, m, t); delete Tm[m]; m = "visitorOnlyApprovedKey" === m; ln(l, g, m); gn(d); l = qd(l); m = hn(d, m,
                function () { Gm.ytExports.logging.transport.leaderQueueLength = 0; h--; h || c() }, function () {
    ...
    ; function qn(a, b) {
        var c = void 0 === c ? {} : c; var d = ym; N("ytLoggingEventsDefaultDisabled", !1) && ym == ym && (d = null); a: {
            c = void 0 === c ? {} : c; if (O("lr_drop_other_and_business_payloads")) { if (Am[a] || zm[a]) break a } else if (O("lr_drop_other_payloads") && Am[a]) break a; var e = {}, f = Math.round(c.timestamp || Q()); e.eventTimeMs = f < Number.MAX_SAFE_INTEGER ? f : 0; e[a] = b; a = Bm(); e.context = { lastActivityMs: String(c.timestamp || !isFinite(a) ? -1 : a) }; O("log_sequence_info_on_gel_web") && c.ma && (a = e.context, b = c.ma, b = { index: pn(b), groupKey: b }, a.sequence =
                b, c.rb && delete nn[c.ma]); (c.zb ? an : Wm)({ endpoint: "log_event", payload: e, R: c.R, ga: c.ga }, d)
        }
    }
    ; var rn = [{
        Ha: function (a) { return "Cannot read property '" + a.key + "'" },
        xa: {
        ...
        Ha: function (a) { return "Cannot call '" + a.key + "'" },
        xa: {
        ...
        Ha: function (a) { return a.key + " is not defined" },
        xa: { ReferenceError: [{ regexp: /(.*) is not defined/, groups: ["key"] }, { regexp: /Can't find variable: (.*)/, groups: ["key"] }] }
    }]; var tn = { Y: [], W: [{ mb: sn, weight: 500 }] }; function sn(a) { if ("JavaException" === a.name) return !0; a = a.stack; return a.includes("chrome://") || a.includes("chrome-extension://") || a.includes("moz-extension://") }
    ...
    function Xn(a, b, c) {
        Yn || (Yn = {}, Th(window, "message", function (d) { a: { if (d.origin === Wn(a, "host")) { try { var e = JSON.parse(d.data) } catch (f) { e = void 0; break a } if (d = Yn[e.id]) d.u = !0, d.u && (D(d.v, d.sendMessage, d), d.v.length = 0), d.Oa(e) } e = void 0 } return e }));
        Yn[c] = b
    }
    ...
    n.setup = function (a, b) {
        var c = document; if (a = "string" === typeof a ? c.getElementById(a) : a) if (c = "iframe" === a.tagName.toLowerCase(), b.host || (b.host = c ? Rb(a.src) : "https://www.youtube.com"), this.j = new Vn(b), c || (b = fo(this, a), this.m = a, (c = a.parentNode) && c.replaceChild(b, a), a = b), this.i = a, this.i.id || (this.i.id = "widget" + Qa(this.i)), Pn[this.i.id] = this, window.postMessage) {
            this.o = new L; go(this); b = Wn(this.j, "events"); for (var d in b) b.hasOwnProperty(d) && this.addEventListener(d, b[d]); for (var e in Rn) Rn.hasOwnProperty(e) &&
                co(this, e)
        }
    };
    ...
    n.sendMessage = function (a) {
        a.id = this.id;
        a.channel = "widget";
        var b = Lf(a), c = [Rb(this.i.src || "").replace("http:", "https:")];
        if (this.i.contentWindow) for (var d = 0; d < c.length; d++)try { this.i.contentWindow.postMessage(b, c[d]) } catch (Ub) {
            if (Ub.name && "SyntaxError" === Ub.name) {
                if (!(Ub.message && 0 < Ub.message.indexOf("target origin ''"))) {
                    var e = void 0, f = Ub; e = void 0 === e ? {} : e; e.name = N("INNERTUBE_CONTEXT_CLIENT_NAME", 1); e.version = N("INNERTUBE_CONTEXT_CLIENT_VERSION"); var g = e || {}, h = "WARNING"; h = void 0 === h ? "ERROR" : h; if (f) {
                        f.hasOwnProperty("level") &&
                            f.level && (h = f.level); if (O("console_log_js_exceptions")) { var k = f, l = []; l.push("Name: " + k.name); l.push("Message: " + k.message); k.hasOwnProperty("params") && l.push("Error Params: " + JSON.stringify(k.params)); k.hasOwnProperty("args") && l.push("Error args: " + JSON.stringify(k.args)); l.push("File name: " + k.fileName); l.push("Stacktrace: " + k.stack); window.console.log(l.join("\n"), k) } if (!(5 <= Gn)) {
                                var m = void 0, q = void 0, t = f, p = g, y = ee(t), z = y.message || "Unknown Error", G = y.name || "UnknownError", K = y.stack || t.j || "Not available";
                                if (K.startsWith(G + ": " + z)) { var M = K.split("\n"); M.shift(); K = M.join("\n") } var P = y.lineNumber || "Not available", kb = y.fileName || "Not available", uc = K, va = 0; if (t.hasOwnProperty("args") && t.args && t.args.length) for (var na = 0; na < t.args.length && !(va = An(t.args[na], "params." + na, p, va), 500 <= va); na++); else if (t.hasOwnProperty("params") && t.params) { var Y = t.params; if ("object" === typeof t.params) for (q in Y) { if (Y[q]) { var ba = "params." + q, ca = Cn(Y[q]); p[ba] = ca; va += ba.length + ca.length; if (500 < va) break } } else p.params = Cn(Y) } if (Jn.length) for (var X =
                                    0; X < Jn.length && !(va = An(Jn[X], "params.context." + X, p, va), 500 <= va); X++); navigator.vendor && !p.hasOwnProperty("vendor") && (p["device.vendor"] = navigator.vendor); var S = { message: z, name: G, lineNumber: P, fileName: kb, stack: uc, params: p, sampleWeight: 1 }, Qj = Number(t.columnNumber); isNaN(Qj) || (S.lineNumber = S.lineNumber + ":" + Qj); if ("IGNORED" === t.level) m = 0; else a: {
                                        for (var Rj = wn(), Sj = u(Rj.Y), Pf = Sj.next(); !Pf.done; Pf = Sj.next()) { var Tj = Pf.value; if (S.message && S.message.match(Tj.Wb)) { m = Tj.weight; break a } } for (var Uj = u(Rj.W),
                                            Qf = Uj.next(); !Qf.done; Qf = Uj.next()) { var Vj = Qf.value; if (Vj.mb(S)) { m = Vj.weight; break a } } m = 1
                                    } S.sampleWeight = m; for (var Wj = u(rn), Rf = Wj.next(); !Rf.done; Rf = Wj.next()) { var Sf = Rf.value; if (Sf.xa[S.name]) for (var Xj = u(Sf.xa[S.name]), Tf = Xj.next(); !Tf.done; Tf = Xj.next()) { var Yj = Tf.value, Ld = S.message.match(Yj.regexp); if (Ld) { S.params["params.error.original"] = Ld[0]; for (var Uf = Yj.groups, Zj = {}, Vb = 0; Vb < Uf.length; Vb++)Zj[Uf[Vb]] = Ld[Vb + 1], S.params["params.error." + Uf[Vb]] = Ld[Vb + 1]; S.message = Sf.Ha(Zj); break } } } S.params || (S.params =
                                        {}); var ak = wn(); S.params["params.errorServiceSignature"] = "msg=" + ak.Y.length + "&cb=" + ak.W.length; S.params["params.serviceWorker"] = "false"; A.document && A.document.querySelectorAll && (S.params["params.fscripts"] = String(document.querySelectorAll("script:not([nonce])").length)); xb("sample").constructor !== wb && (S.params["params.fconst"] = "true"); var ra = S; window.yterr && "function" === typeof window.yterr && window.yterr(ra); if (0 !== ra.sampleWeight && !Fn.has(ra.message)) {
                                            if ("ERROR" === h) {
                                                xn.fa("handleError", ra); if (O("record_app_crashed_web") &&
                                                ...
                                                h && xn.fa("handleWarning", ra); if (O("kevlar_gel_error_routing")) a: {
                                                    var Wf = void 0, Xf = void 0, Hc = h, R = ra; if (O("errors_via_jspb")) {
                                                        if (Ln()) Xf = void 0; else {
                                                            ...
                                                            F(qb, 6, R.sampleWeight); "ERROR" === Hc ? F(qb, 2, 2) : "WARNING" === Hc ? F(qb, 2, 1) : F(qb, 2, 0); var Yf = new jh; F(Yf, 1, !0); kd(Yf, ih, 3, kh, Wb); var rb = new fh; F(rb, 3, window.location.href); for (var hk = N("FEXP_EXPERIMENTS", []), Zf = 0; Zf < hk.length; Zf++) { var ik = rb, no = hk[Zf]; Rc(ik); fd(ik, 5).push(no) } var $f = Fh(); if (!Gh() && $f) for (var jk = u(Object.keys($f)), sb = jk.next(); !sb.done; sb = jk.next()) { var kk = sb.value, ag = new hh; F(ag, 1, kk); ag.setValue(String($f[kk])); md(rb, 4, hh, ag) } var bg = R.params; if (bg) {
                                                                var lk = u(Object.keys(bg)); for (sb = lk.next(); !sb.done; sb =
                                                                    lk.next()) { var mk = sb.value, cg = new hh; F(cg, 1, "client." + mk); cg.setValue(String(bg[mk])); md(rb, 4, hh, cg) }
                                                            } var nk = N("SERVER_NAME"), ok = N("SERVER_VERSION"); if (nk && ok) { var dg = new hh; F(dg, 1, "server.name"); dg.setValue(nk); md(rb, 4, hh, dg); var eg = new hh; F(eg, 1, "server.version"); eg.setValue(ok); md(rb, 4, hh, eg) } var Md = new mh; H(Md, fh, 1, rb); H(Md, jh, 2, Yf); H(Md, lh, 3, qb); Xf = Md
                                                        } var pk = Xf; if (!pk) break a; var qk = new th; kd(qk, mh, 163, uh, pk); En(qk)
                                                    } else {
                                                        if (Ln()) Wf = void 0; else {
                                                            var Ic = { stackTrace: R.stack }; R.fileName && (Ic.filename =
                                                                R.fileName); var Ka = R.lineNumber && R.lineNumber.split ? R.lineNumber.split(":") : []; 0 !== Ka.length && (1 !== Ka.length || isNaN(Number(Ka[0])) ? 2 !== Ka.length || isNaN(Number(Ka[0])) || isNaN(Number(Ka[1])) || (Ic.lineNumber = Number(Ka[0]), Ic.columnNumber = Number(Ka[1])) : Ic.lineNumber = Number(Ka[0])); var fg = { level: "ERROR_LEVEL_UNKNOWN", message: R.message, errorClassName: R.name, sampleWeight: R.sampleWeight }; "ERROR" === Hc ? fg.level = "ERROR_LEVEL_ERROR" : "WARNING" === Hc && (fg.level = "ERROR_LEVEL_WARNNING"); var oo = { isObfuscated: !0, browserStackInfo: Ic },
                                                                    Xb = { pageUrl: window.location.href, kvPairs: [] }; N("FEXP_EXPERIMENTS") && (Xb.experimentIds = N("FEXP_EXPERIMENTS")); var gg = Fh(); if (!Gh() && gg) for (var rk = u(Object.keys(gg)), tb = rk.next(); !tb.done; tb = rk.next()) { var sk = tb.value; Xb.kvPairs.push({ key: sk, value: String(gg[sk]) }) } var hg = R.params; if (hg) { var tk = u(Object.keys(hg)); for (tb = tk.next(); !tb.done; tb = tk.next()) { var uk = tb.value; Xb.kvPairs.push({ key: "client." + uk, value: String(hg[uk]) }) } } var vk = N("SERVER_NAME"), wk = N("SERVER_VERSION"); vk && wk && (Xb.kvPairs.push({
                                                                        key: "server.name",
                                                                        value: vk
                                                                    }), Xb.kvPairs.push({ key: "server.version", value: wk })); Wf = { errorMetadata: Xb, stackTrace: oo, logMessage: fg }
                                                        } var xk = Wf; if (!xk) break a; qn("clientError", xk)
                                                    } if ("ERROR" === Hc || O("errors_flush_gel_always_killswitch")) O("web_fp_via_jspb") && on(!0), on()
                                                } if (!O("suppress_error_204_logging")) {
                                                    var ub = ra, Jc = ub.params || {}, $a = {
                                                        urlParams: { a: "logerror", t: "jserror", type: ub.name, msg: ub.message.substr(0, 250), line: ub.lineNumber, level: h, "client.name": Jc.name }, postParams: { url: N("PAGE_NAME", window.location.href), file: ub.fileName },
                                                        method: "POST"
                                                    }; Jc.version && ($a["client.version"] = Jc.version); if ($a.postParams) { ub.stack && ($a.postParams.stack = ub.stack); for (var yk = u(Object.keys(Jc)), ig = yk.next(); !ig.done; ig = yk.next()) { var zk = ig.value; $a.postParams["client." + zk] = Jc[zk] } var jg = Fh(); if (jg) for (var Ak = u(Object.keys(jg)), kg = Ak.next(); !kg.done; kg = Ak.next()) { var Bk = kg.value; $a.postParams[Bk] = jg[Bk] } var Ck = N("SERVER_NAME"), Dk = N("SERVER_VERSION"); Ck && Dk && ($a.postParams["server.name"] = Ck, $a.postParams["server.version"] = Dk) } qi(N("ECATCHER_REPORT_HOST",
                                                        "") + "/error_204", $a)
                                                } try { Fn.add(ra.message) } catch (to) { } Gn++
                                        }
                            }
                    }
                }
    ...
    }; function ho(a) { return (0 === a.search("cue") || 0 === a.search("load")) && "loadModule" !== a }
    ...
    function lo(a, b) {
        D(b, function (c) {
            this[c] || ("getCurrentTime" === c ? this[c] = function () { var d = this.playerInfo.currentTime; if (1 === this.playerInfo.playerState) { var e = (Date.now() / 1E3 - this.playerInfo.currentTimeLastUpdated_) * this.playerInfo.playbackRate; 0 < e && (d += Math.min(e, 1)) } return d } : ho(c) ? this[c] = function () {
                this.playerInfo = {};
                this.N = {}; eo(this, c, arguments); return this
    ...
    n.getVideoEmbedCode = function () {
        var a = Wn(this.j, "host") + ("/embed/" + Wn(this.j, "videoId")), b = Number(Wn(this.j, "width")), c = Number(Wn(this.j, "height")); if (isNaN(b) || isNaN(c)) throw Error("Invalid width or height property"); b = Math.floor(b); c = Math.floor(c); Gb.test(a) && (-1 != a.indexOf("&") && (a = a.replace(Ab, "&amp;")), -1 != a.indexOf("<") && (a = a.replace(Bb, "&lt;")), -1 != a.indexOf(">") && (a = a.replace(Cb, "&gt;")), -1 != a.indexOf('"') && (a = a.replace(Db, "&quot;")), -1 != a.indexOf("'") && (a = a.replace(Eb, "&#39;")), -1 != a.indexOf("\x00") &&
    ...
    Qn.push(function (a) {
        var b = a; b || (b = document); a = gb(b.getElementsByTagName("yt:player")); var c = b || document; if (c.querySelectorAll && c.querySelector) b = c.querySelectorAll(".yt-player"); else {
            var d; c = document; b = b || c; if (b.querySelectorAll && b.querySelector) b = b.querySelectorAll(".yt-player"); else if (b.getElementsByClassName) { var e = b.getElementsByClassName("yt-player"); b = e } else {
                e = b.getElementsByTagName("*"); var f = {}; for (c = d = 0; b = e[c]; c++) {
                    var g = b.className, h; if (h = "function" == typeof g.split) h = 0 <= cb(g.split(/\s+/),
                        "yt-player"); h && (f[d++] = b)
                } f.length = d; b = f
            }
        } b = gb(b); D(fb(a, b), po)
    });
    "undefined" != typeof YTConfig && YTConfig.parsetags && "onload" != YTConfig.parsetags || Sn(); var qo = A.onYTReady; qo && qo(); var ro = A.onYouTubeIframeAPIReady; ro && ro(); var so = A.onYouTubePlayerAPIReady; so && so();
}).call(this);